...
#[cfg(feature = "hash")]
// TODO: fix hsahrst
bus! { HASH => (AHB2, 5, hashen, hashlpen,hsahrst),}
...
cfg_select! {
    any(
        ...
        bus! { SAI => (APB2, 22, sai1en, sai1lpen, sai1rst),}
    }
    _ => {
        bus! { SAI1 => (APB2, 22, sai1en, sai1lpen, sai1rst),}
    }
}

#[cfg(feature = "sai2")]
bus! { SAI2 => (APB2, 23, sai2en, sai2lpen, sai2rst),}
