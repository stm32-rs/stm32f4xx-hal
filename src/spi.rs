...
pub trait SpiExt: Sized + Instance {
    fn spi(
        self,
        pins: (Option<Self::Sck>, Option<Self::Miso>, Option<Self::Mosi>),
        mode: impl Into<Mode>,
        freq: Hertz,
        clocks: &Clocks,
    ) -> Spi<Self, false, u8>;
    ...
    fn spi_bidi(
        self,
        pins: (Option<Self::Sck>, Option<Self::Mosi>),
        mode: impl Into<Mode>,
        freq: Hertz,
        clocks: &Clocks,
    ) -> Spi<Self, true, u8>;
    ...
    fn spi_bidi_slave(
        self,
        pins: (Option<Self::Sck>, Option<Self::Miso>, Option<Self::Nss>),
        mode: impl Into<Mode>,
...
impl<SPI: Instance> Spi<SPI, true, u8> {
    ...
    pub fn new_bidi(
        spi: SPI,
        pins: (Option<SPI::Sck>, Option<SPI::Mosi>),
        mode: impl Into<Mode>,
        freq: Hertz,
        clocks: &Clocks,
    ) -> Self {
...
impl<SPI: Instance> SpiSlave<SPI, true, u8> {
    ...
    pub fn new_bidi(
        spi: SPI,
        pins: (Option<SPI::Sck>, Option<SPI::Miso>, Option<SPI::Nss>),
        mode: impl Into<Mode>,
    ) -> Self {
        unsafe {
            SPI::enable_unchecked();
        ...
        let pins = (pins.0, pins.1, None, pins.2);
...
impl<SPI: Instance, const BIDI: bool, W> Spi<SPI, BIDI, W> {
    fn _new(spi: SPI, pins: (Option<SPI::Sck>, Option<SPI::Miso>, Option<SPI::Mosi>)) -> Self {
        Self {
            inner: Inner::new(spi),
            pins,
