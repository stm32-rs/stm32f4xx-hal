...
cfg_select! {
    ...
    any(feature = "stm32f405", feature = "stm32f415") => {
        adc_pins!(
            gpio::PA0<Analog> => (ADC1, 0),
    ...
    any(feature = "stm32f407", feature = "stm32f417") => {
        adc_pins!(
            gpio::PA0<Analog> => (ADC1, 0),
            gpio::PA0<Analog> => (ADC2, 0),
            gpio::PA0<Analog> => (ADC3, 0),
    ...
    any(feature = "stm32f413", feature = "stm32f423") => {
        adc_pins!(
            gpio::PA0<Analog> => (ADC1, 0),
            gpio::PA1<Analog> => (ADC1, 1),
            gpio::PA2<Analog> => (ADC1, 2),
    ...
    any(feature = "stm32f427", feature = "stm32f437") => {
        adc_pins!(
            gpio::PA0<Analog> => (ADC1, 0),
            gpio::PA0<Analog> => (ADC2, 0),
            gpio::PA0<Analog> => (ADC3, 0),
    ...
    any(feature = "stm32f429", feature = "stm32f439") => {
        adc_pins!(
            gpio::PA0<Analog> => (ADC1, 0),
            gpio::PA0<Analog> => (ADC2, 0),
            gpio::PA0<Analog> => (ADC3, 0),
    ...
    any(feature = "stm32f469", feature = "stm32f479") => {
        adc_pins!(
            gpio::PA0<Analog> => (ADC1, 0),
            gpio::PA0<Analog> => (ADC2, 0),
            gpio::PA0<Analog> => (ADC3, 0),
